            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-4 ">Category Permission</h4>
                            ...
                            <tbody>
                                @foreach ($data as $key)
                                    <tr>
                                        ...
                                        <td> <a href="{{ url('admin/permission/edit') . '/' . $key->id }}"
                                                class="btn btn-primary">
                                                <i class="bx bx-pencil"></i>
                                                Edit</a>
                                        </td>
                                        <td>
                                            <a href="#" onClick="DeleteUser('{{ $key->id }}')"
                    ...
                    <div class="modal fade" id="DeletePopup" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form class="user" action="{{ url('admin/permission/delete') }}" method="POST">
                                    @csrf
