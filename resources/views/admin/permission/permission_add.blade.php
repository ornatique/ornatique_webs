...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3">Permission Add</h4>
                <div class="row">

                    <form action="{{ url('admin/permission/add') }}" method="post" enctype="multipart/form-data">@csrf
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="user_id" required>
                                    ...
                                    <option class="form-control form-select"
                                        {{ old('id') == $user->id ? 'selected' : '' }} value="{{ $user->id }}">
                                        {{ ucfirst($user->number) }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="category_id"
                                    ...
                                    <option class="form-control form-select"
                                        {{ old('id') == $category->id ? 'selected' : '' }} value="{{ $category->id }}">
