    ...
    <div class="row">
        <div class="col-12">
            <div class="card" style="height: 500px">
                <div class="card-body">
                    <h4 class="card-title mb-3">Link Edit</h4>
                    <form action="{{ url('admin/social/edit') . '/' . $data->id }}" method="post"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input required class="form-control @error('facebook') is-invalid @enderror"
                                        type="url" name="facebook" value="{{ $data->facebook }}"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input required class="form-control @error('twitter') is-invalid @enderror"
                                        type="url" name="twitter" value="{{ $data->twitter }}" placeholder="Enter Link*"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input required class="form-control @error('instagram') is-invalid @enderror"
                                        type="url" name="instagram" value="{{ $data->instagram }}"
                                        placeholder="Enter Link*" id="example-text-input">
                                    @error('instagram')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input required class="form-control @error('linkedin') is-invalid @enderror"
                                        type="url" name="linkedin" value="{{ $data->linkedin }}"
                                        placeholder="Enter Link*" id="example-text-input">
                                    @error('linkedin')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input required class="form-control @error('whatsapp') is-invalid @enderror"
                                        type="url" name="whatsapp" value="{{ $data->whatsapp }}"
                                        placeholder="Enter Link*" id="example-text-input">
                                    @error('whatsapp')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input required class="form-control @error('youtube') is-invalid @enderror"
                                        type="url" name="youtube" value="{{ $data->youtube }}"
                                        placeholder="Enter Link*" id="example-text-input">
                                    @error('youtube')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
