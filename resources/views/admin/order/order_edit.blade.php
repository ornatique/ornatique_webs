    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Estimate Status Edit</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Estimate Status Edit</li>
                        </ol>
                    </nav>
                </div>
                @if ($errors->any())
            ...
            <div class="card">
                <div class="card-body">
                    <div class="overflow-hidden card-title">
                        <span class="float-start fs-5 fw-bolder mb-0">Estimate Status Edit</span>
                        <a href="{{ url()->previous() }}"><button type="button"
                                class="float-end btn btn-danger m-1 px-3">Cancel
                            </button></a>
                    </div>
                    <form class="row g-3" action="{{ route('admin_order_edit', ['id' => $data->id]) }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6">
                            <label for="inputFirstName" class="form-label">Estimate Name</label>
