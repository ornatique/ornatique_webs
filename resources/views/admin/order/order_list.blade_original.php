    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                ...
                <div class="toast fade bg-success top-right" id="toast-container-order" role="alert"
                    ...
                    <table id="dataTable-order" class="table table-bordered dt-responsive nowrap w-100 display">
                        ...
                        <tbody>
                            ...
                            <tr id="tr{{ $key->id }}">
                                ...
                                <td>{{ number_format($key->weight, 3)  }}</td>
                                <td>{{ $key->quantity }}</td>
                                {{-- <td>{{ $key->remarks }}</td> --}}
                                <td style="white-space: break-spaces">
                                    <select name="status" data-id="{{ $key->id }}" style="width: 150px"
                                        ...
                                        <option value="Finishing" {{ $key->status == 'Finishing' ? 'selected' : '' }}>
                                            Finishing</option>
                                ...
                                <td>
                                    <a href="#" onClick="DeleteUser('{{ $key->id }}','tr{{ $key->id }}')"
