        ...
        <div class="col-12">
            <div class="card" style="height: 500px">
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/link/edit') . '/' . $data->id }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input required class="form-control @error('link') is-invalid @enderror" type="url"
                                        name="link" value="{{ $data['link'] }}" placeholder="Enter Link*"
                                        id="example-text-input">
                                    @error('link')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    <label for="example-text-input" class="form-label">Icon <span class="text-danger">
                                            *</span></label>
                                    @if ($data['icon'])
                                        <img src="{{ asset('public/assets/images/links') . '/' . $data->icon }}"
