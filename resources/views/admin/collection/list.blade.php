                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <h4 class="card-title mb-4 ">
                            <a href="{{ url('admin/collection/add') }}">
                            ...
                            <tbody>
                                @foreach ($data as $essential)
                                    <tr id="tr{{ $essential->id }}">
                                        ...
                                        <td>
                                            <a href="{{ url('admin/collection/edit/' . $essential->id) }}"
                    ...
                    <div class="modal fade" id="DeletePopup" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form class="user" action="{{ url('admin/collection/delete') }}" method="POST">
                                    @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete_button', function(e) {
                ...
                $.ajax({
                    method: 'POST',
                    url: "{{ url('admin/collection/delete') }}",
                    data: {
                        id: id,
                        _token: '{{ csrf_token() }}',
                    },
