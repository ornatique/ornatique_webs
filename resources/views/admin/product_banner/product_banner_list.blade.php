            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-4 ">Product Advertise List</h4>
                        <h4 class="card-title mb-4 ">
                            <a href="{{ route('admin_products_add') }}">
                                <button class="btn btn-primary">
                                    <i class="bx bx-plus"></i>
                                    Add Product Advertise
                                </button>
                            </a>
                        </h4>
                    </div>
                                ...
                                @foreach ($data as $key)
                                    <tr>
                                       <td>{{ $loop->iteration }}</td>
                                        ...
                                        <td>
                                            <img width='80'
                                                src="{{ asset('public/assets/images/banners') . '/' . $key->image }}"
                                                alt="">
                                        </td>
                                        <td> <a href="{{ url('admin/product/banner/edit') . '/' . $key->id }}"
                    ...
                    <div class="modal fade" id="DeletePopup" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form class="user" action="{{ url('admin/product/banners/delete') }}" method="POST">
                                    @csrf
